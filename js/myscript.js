...
function onResize() {
    if(innerWidth<590){
        ...
        document.getElementById("user_in").innerHTML ="<div class='menu'><ul ><li> <a href='../SoftTechProject'>Home</a>&nbsp;|&nbsp;</li> <li> <a href='?blogs'>Blogs</a>&nbsp;|&nbsp;</li> <li>  <a href='?contacts'>Feedback</a>&nbsp;|&nbsp;</li> <li><div class='dropdown'><button class='dropbtn'><a href='#'>Profile <span style='font-size:14px;'>&#9660;</span></a></button><div class='dropdown-content'><a href='?profile'>Profile info</a><a href='?myarticles'>My articles</a><a href='?article/create'>Create new article</a><a href='?logout'>Logout</a></div></div></li> </ul> </div>";
